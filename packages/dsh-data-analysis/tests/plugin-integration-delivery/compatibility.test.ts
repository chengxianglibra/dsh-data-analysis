...
test('v2 compatibility manifest binds plugin, DSH, Marivo, and project contracts', () => {
  assert.equal(PLUGIN_VERSION, '0.1.2-dev.0')
  ...
  assert.equal(MARIVO_VERSION, '0.5.3.dev0')
  assert.equal(MARIVO_PACKAGE_SPEC, 'marivo[duckdb,trino,clickhouse]==0.5.3.dev0')
