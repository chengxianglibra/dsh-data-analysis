...
.pd-catalog{padding:20px}.pd-catalog-controls{display:flex}.pd-catalog input,.pd-catalog button,.pd-history button{font:inherit;color:inherit}.pd-catalog input{width:100%;min-width:0;padding:9px 12px;border:1px solid var(--dsw-alias-border-l2,#dce5e5);border-radius:6px;background:var(--dsw-alias-bg-base,#fff)}
