...
export const MARIVO_REPORT_RENDERING_PROMPT = [
  ...
  'For stakeholder reports, put a 2-4 item answer-first executive summary first, then pair each major conclusion with an explicit Artifact-backed chart or table, plain-language interpretation, and a concrete implication; finish with supported next steps, decision-relevant open questions, and caveats.',
  ...
  'ReportDocument v2 has no Finding IDs or evidence blocks: use only text, chart, and table blocks, and bind every chart or table directly to its exact Artifact ref.',
